...
#Modify teacher 
def modify_teacher(day,my_time,period,teacher):
    #need to check if it is real day
    if day in g_thisdict.keys():
       my_time = my_time.replace(" ", "")
       if my_time in g_thisdict[day].keys():
          if period == g_thisdict[day][my_time][0]:
             g_thisdict[day][my_time][1] = teacher
             return True
          else:
             print "Invalid period:" + period
             return False
       else:
         print "Invalid time:" + my_time
         return False
    else:
       print "Invalid Day:" + day
       return False
...
#delete example as Tue is no school day:
day="Tue"
ret=no_school_day(day)
if ret is True:
   print_schedule()

print "4. Test to modify the replace the teacher with substitute"
#modify example change schedule Wed, 4pm-5pm, period 9, Mr.B to Wed, 4pm-5pm, period 9, Mr.P
day="Wed"
period="period 9"
time_period="4 pm -5 pm"
teacher = "Mr.P"
ret=modify_teacher(day,time_period,period,teacher)
if ret is True:
   print_schedule()
